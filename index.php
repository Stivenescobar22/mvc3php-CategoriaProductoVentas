 ...
 $controller_ventas = new Tblventas_controller();
    ...
    if(!empty($_REQUEST['accion'])){
        ...
        switch($metodo){
            ...
            case method_exists($controller_ventas, $metodo):

              $controller_ventas->$metodo();  
